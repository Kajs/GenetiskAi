...
public class OldGameState_AngleChange extends Observable {
	private Board board;
	...
	public OldGameState_AngleChange(Coordinate startPosition, int rows, int columns, double hexSideSize) {
		this.rows = rows;
