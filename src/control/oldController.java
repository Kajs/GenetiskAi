...
public class Controller {
	...
	public Controller(boolean automatic, boolean displayAutomatic) {
		...
		for (int i = 0; i < numThreads; i++) {
			gameThreads[i] = new GameThread(new GameState(startPosition, rows, columns, hexSideSize), firstTeam, lastTeam, enemyDifficulty, maxRounds, geneticPositions, staticPositions, geneticAlgorithm);
	...
	//------------------------- team positions
		...
		public void setTeamPositions(boolean random) {
			if(random) {
				...
				geneticPositions[0][0] = new Coordinate(6, 5);
				geneticPositions[1][0] = new Coordinate(3, 11);
				geneticPositions[2][0] = new Coordinate(10, 17);
				/*
				...
				staticPositions[0][0] = new Coordinate(3, 1);
				staticPositions[1][0] = new Coordinate(10, 2);
				staticPositions[2][0] = new Coordinate(0, 10);
